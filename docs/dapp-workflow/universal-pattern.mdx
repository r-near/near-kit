...
description: "Write once, run anywhere - backend, frontend, or tests"
---
...
This allows you to write "Universal Business Logic"—functions that define _what_ to do, without caring _where_ they are running.
